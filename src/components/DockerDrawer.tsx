...
import { DockerManagerPanel } from "./DockerManagerPanel";
...
export function DockerDrawer({ open, onClose }: DockerDrawerProps) {
  return (
    <div
    ...
    >
      <div className="h-full w-[22rem] flex flex-col">
        <div className="h-10 px-3 border-b border-zinc-800 flex items-center justify-between shrink-0">
          <span className="text-sm font-medium text-zinc-200">Docker</span>
          <button
            type="button"
            onClick={onClose}
